...
set "TEST_PROJECT_DIR=D:\L3\GProjet\VroomerDashboard\project"
...
set "PROJECT_LIB_DIR=%TEST_PROJECT_DIR%\target\lib"
set "FRAMEWORK_JAR=%PROJECT_LIB_DIR%\framework.jar"
...
echo framework.jar cree et copie dans %PROJECT_LIB_DIR%
